...
NON_SPACE_PATTERN = re.compile(r"\S+", re.IGNORECASE)
SPACE_PATTERN = re.compile(r"\s+", re.IGNORECASE)
SPACE_PATTERN_END = re.compile(r"\s+$", re.IGNORECASE)
SPACE_PATTERN_START = re.compile(r"^\s+", re.IGNORECASE)
NON_ALPHANUM_PATTERN = re.compile(r"[^\w\d]+", re.IGNORECASE)
NON_ALPHANUM_PATTERN_END = re.compile(r"[^\w\d]+$", re.IGNORECASE)
NON_ALPHANUM_PATTERN_START = re.compile(r"^[^\w\d]+", re.IGNORECASE)
ALPHANUM_PATTERN = re.compile(r"[\w\d]+", re.IGNORECASE)
...
class Search(Handler):
    ...
    def mark(self) -> None:
        ...
        if text:
            match_case = "i" if text.islower() else "I"
